...
# ============================================================================
# BRONZE INGEST: merchant_categories
# ----------------------------------------------------------------------------
# Lands the raw source CSV for merchant_categories as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for merchant_categories in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["mcc", "category_name", "category_group"]
RECORD_ID_COLS = ["mcc"]
