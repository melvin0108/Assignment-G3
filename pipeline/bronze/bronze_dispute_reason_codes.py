...
# ============================================================================
# BRONZE INGEST: dispute_reason_codes
# ----------------------------------------------------------------------------
# Lands the raw source CSV for dispute_reason_codes as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for dispute_reason_codes in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["reason_code", "description"]
RECORD_ID_COLS = ["reason_code"]
