...
# ============================================================================
# BRONZE INGEST: case_transactions
# ----------------------------------------------------------------------------
# Lands the raw source CSV for case_transactions as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for case_transactions in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["case_id", "transaction_id", "linked_at"]
RECORD_ID_COLS = ["case_id", "transaction_id"]
