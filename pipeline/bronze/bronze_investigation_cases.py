...
# ============================================================================
# BRONZE INGEST: investigation_cases
# ----------------------------------------------------------------------------
# Lands the raw source CSV for investigation_cases as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for investigation_cases in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["case_id", "priority", "status_code", "fraud_type_code", "owner_employee_id", "opened_at", "closed_at", "legal_hold"]
RECORD_ID_COLS = ["case_id"]
