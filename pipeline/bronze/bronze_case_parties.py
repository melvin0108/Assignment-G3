...
# ============================================================================
# BRONZE INGEST: case_parties
# ----------------------------------------------------------------------------
# Lands the raw source CSV for case_parties as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for case_parties in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["case_id", "party_type", "party_id", "role"]
RECORD_ID_COLS = ["case_id", "party_type", "party_id"]
