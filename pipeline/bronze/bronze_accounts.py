...
# ============================================================================
# BRONZE INGEST: accounts
# ----------------------------------------------------------------------------
# Lands the raw source CSV for accounts as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for accounts in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["account_id", "customer_id", "product_type", "open_date", "status", "currency"]
RECORD_ID_COLS = ["account_id"]
