...
# ============================================================================
# BRONZE INGEST: currencies
# ----------------------------------------------------------------------------
# Lands the raw source CSV for currencies as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for currencies in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["currency_code", "name", "decimals"]
RECORD_ID_COLS = ["currency_code"]
