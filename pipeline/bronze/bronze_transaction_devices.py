...
# ============================================================================
# BRONZE INGEST: transaction_devices
# ----------------------------------------------------------------------------
# Lands the raw source CSV for transaction_devices as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for transaction_devices in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["device_id", "transaction_id", "device_type", "ip", "geo_country"]
RECORD_ID_COLS = ["device_id"]
