...
# ============================================================================
# BRONZE INGEST: disputes
# ----------------------------------------------------------------------------
# Lands the raw source CSV for disputes as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for disputes in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["dispute_id", "transaction_id", "reason_code", "amount", "status", "raised_at"]
RECORD_ID_COLS = ["dispute_id"]
