...
# ============================================================================
# BRONZE INGEST: case_status_types
# ----------------------------------------------------------------------------
# Lands the raw source CSV for case_status_types as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for case_status_types in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["status_code", "description"]
RECORD_ID_COLS = ["status_code"]
