...
# ============================================================================
# BRONZE INGEST: date_dim
# ----------------------------------------------------------------------------
# Lands the raw source CSV for date_dim as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for date_dim in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["date_id", "year", "month", "quarter", "is_weekend"]
RECORD_ID_COLS = ["date_id"]
