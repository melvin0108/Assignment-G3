...
# ============================================================================
# BRONZE INGEST: fraud_alerts
# ----------------------------------------------------------------------------
# Lands the raw source CSV for fraud_alerts as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for fraud_alerts in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["alert_id", "transaction_id", "rule_name", "score", "triggered_at", "disposition"]
RECORD_ID_COLS = ["alert_id"]
