...
# ============================================================================
# BRONZE INGEST: merchants
# ----------------------------------------------------------------------------
# Lands the raw source CSV for merchants as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for merchants in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["merchant_id", "name", "mcc", "country", "risk_rating", "status"]
RECORD_ID_COLS = ["merchant_id"]
