...
# ============================================================================
# BRONZE INGEST: investigation_notes
# ----------------------------------------------------------------------------
# Lands the raw source CSV for investigation_notes as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for investigation_notes in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["note_id", "case_id", "author_employee_id", "note_text", "created_at"]
RECORD_ID_COLS = ["note_id"]
