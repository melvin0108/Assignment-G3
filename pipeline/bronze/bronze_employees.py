...
# ============================================================================
# BRONZE INGEST: employees
# ----------------------------------------------------------------------------
# Lands the raw source CSV for employees as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for employees in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["employee_id", "full_name", "email", "team", "role"]
RECORD_ID_COLS = ["employee_id"]
