...
# ============================================================================
# BRONZE INGEST: fraud_types
# ----------------------------------------------------------------------------
# Lands the raw source CSV for fraud_types as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for fraud_types in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["fraud_type_code", "description", "severity"]
RECORD_ID_COLS = ["fraud_type_code"]
