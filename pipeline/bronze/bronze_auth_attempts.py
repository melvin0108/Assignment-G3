...
# ============================================================================
# BRONZE INGEST: auth_attempts
# ----------------------------------------------------------------------------
# Lands the raw source CSV for auth_attempts as a string-typed Bronze Delta table
# with the 8 metadata columns (docs/bronze-layer.md S4). Mirrors the
# CREATE TABLE + COPY INTO block for auth_attempts in 01_ingest_bronze.sql.
...
SOURCE_COLS = ["attempt_id", "transaction_id", "decision", "decline_reason", "auth_ts"]
RECORD_ID_COLS = ["attempt_id"]
